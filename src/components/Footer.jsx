...
function Footer() {
    return (
        <section className="bg-dark-primary h-fit py-16 dark:bg-dark-bone">
            <div className="container  flex gap-10 md:gap-0 px-10 md:px-0 flex-wrap justify-evenly">
                {/* First Div */}
                <div className="felx w-full md:w-1/3 flex-col">
                    <h1 className="text-bone mb-4 text-2xl">Business Inquires 📨</h1>
                ...
                <div className="felx w-full md:w-1/3 flex-col">
                    ...
                    <div className="flex p-4 gap-4">
                        {/* Github */}
                        <div className='group z-[5] w-9 h-auto border p-[0.4rem] rounded-full  border-l cursor-pointer hover:bg-black hover:text-white duration-500 border-white hover:border-black'>
                        ...
                        {/* Instagram */}
                        <div className='group z-[5] w-9 h-auto border p-[0.4rem] rounded-full  border-l cursor-pointer hover:bg-gradient-to-tr hover:from-[#ae13cd] hover:to-[#f6184e] hover:border-none duration-500 border-white'>
                        <a href="https://github.com/irsyadagungh">
                        ...
                        {/* Linkedin */}
                        <div className='group z-[5] w-9  h-auto border p-[0.4rem] rounded-full border-l cursor-pointer hover:bg-[#136bc5] hover:border-[#136bc5] duration-500 border-white dark:hover:border-[#136bc5]'>
                        <a href="https://github.com/irsyadagungh" >
